(function() {
    ...
    */
    console.log('\nOperation:');
    var operation = justMod2Or3.reduce(function(prev, item) {
        return (prev + 1) * item;
    }, 0);
    ...
    */
    console.log('\nOperation 2:');
    var operation2 = justMod2Or3.reduceRight(function (prev, item) {
        return (prev + 1) * item;
    }, 0);
    ...
    */
    ...
    var name = ['FE','LI','PE'];
    console.log(
        name.reduce(function(prev, item) {
            return prev + 'P' + item;
        }, '')
    );
    ...
    */
    console.log('\nInversed Name:');
    var inversedName = name.reduceRight(function (prev, item) {
        return prev + item;
    });
    ...
    */
    ...
    console.log('Deu FALSE pois os objetos não são literais...');
